...
insert into ambulatorio (nombre, direccionPostal, anoConstruccion, provincia)
	values ('Fingoi', 'Rua Armorica, s/n, 27002 Lugo', '1950', 'Lugo');
...
insert into material (tipo, descripcion, coste, fechaCompra, medico)
	values
	('bisturi', 'Elemento quirurgico.', 12.05, '2020-03-12', TRUE),
	('ordenador', 'Ordenador empleado por el usuario administrador.', 1299.99, '2012-09-25', FALSE);
...
insert into personalNoSanitario (dni, nombre, fechaIncorporacion, telefono, sueldo, tipo)
...
insert into personalNoSanitario (dni, nombre, fechaIncorporacion, telefono, sueldo, tipo)
	values ('00000000A', 'a', '2000-01-01', '999999999', 0.01, 'dueño');
insert into personalAdministrador (personal, contrasena)
	values ('00000000A', 'a');
...
insert into ambulatorio (nombre, direccionPostal, anoConstruccion, provincia)
	values('Galeras', 'Rua de Entrerrios, 3, 15705 Santiago de Compostela', '1920', 'A Coruña');
...
insert into material (tipo, descripcion, coste, fechaCompra, medico)
	values
	('bisturi', 'Elemento quirurgico.', 12.3, '2019-10-01', TRUE),
	('ordenador', 'Ordenador empleado por el usuario administrador.',900.99 ,'2012-09-25', FALSE),
	('camilla', 'Elemento de las consultas.', 400.0 ,'2018-03-09', TRUE);

insert into asociado (hospital, distancia)
	values ((select codigoHospital from hospital where nombre like 'Polusa' and provincia like 'Lugo'), 5.2);

insert into personalNoSanitario (dni, nombre, fechaIncorporacion, telefono, sueldo, tipo)
	values ('76589765T', 'Pablo Tarrio', '2019-05-30', '678543226', 1674.23, 'secretario');

insert into personalAdministrador (personal,contrasena)
	values ('76589765T','char');

insert into personalNoSanitario (dni, nombre, fechaIncorporacion, telefono, sueldo, tipo)
	values ('10000000A', 'p', '2000-01-01', '999999999', 0.01, 'dueño');
insert into personalAdministrador (personal, contrasena)
	values ('10000000A', 'p');
