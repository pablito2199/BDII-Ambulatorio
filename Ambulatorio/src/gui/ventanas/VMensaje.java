...
public class VMensaje extends javax.swing.JDialog {
     ...
     */
    //Contructor
    public VMensaje(java.awt.Frame parent, boolean modal, String txtMensaje) {
        super(parent, modal);
        initComponents();
        textoExcepcion.setText(txtMensaje);
    ...
    //Función que permite cerrar la ventana
    private void btnCerrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCerrarActionPerformed
        //La ventana JDialog VAviso es destruida y limpiada por el sistema operativo.
        this.dispose();
