...
public class VAutentificacion extends javax.swing.JDialog {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (fa.comprobarAutentificacion(textoUsuario.getText(), textoContrasena.getText())) //En caso de tener acceso a la misma (ser administrador) borramos la ventana JFrame
        {
            this.dispose();
